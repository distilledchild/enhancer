...
#SBATCH -o /lustre/isaac24/proj/UTHSC0013/panjun_work/juicer/create_hic_250M_%j.log
#SBATCH -J hic-ds-250M
...
for i in "${!SAMPLES[@]}"; do
  ...
  INPUT="${OUTDIR}/${SAMPLE}_merged_nodups_q30_250M_seed${SEED}.txt"
  OUTPUT="${OUTDIR}/${SAMPLE}_inter_30_250M_seed${SEED}.hic"
  ...
  echo "${SAMPLE}: .hic completed"
done

echo "All 250M .hic files completed"
