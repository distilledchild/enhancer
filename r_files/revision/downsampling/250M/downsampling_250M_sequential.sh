...
#SBATCH -o /lustre/isaac24/proj/UTHSC0013/panjun_work/juicer/downsampling_250M_%j.log
#SBATCH -J DS_250M
...
# These seven libraries have at least 250M valid MAPQ >=30 Hi-C contacts.
SAMPLES=(592BB 607 D765A DA21A DA68A DBA9A DE8BA)
EXPECTED=(259559222 419977942 284296675 382917950 378608379 380788024 302314076)
...
for i in "${!SAMPLES[@]}"; do
  ...
  OUTDIR="${ROOT}/juicer_downsample_q30_250M/${SAMPLE}/seed${SEED}"
  OUTPUT="${OUTDIR}/${SAMPLE}_merged_nodups_q30_250M_seed${SEED}.txt"
  ...
  if [[ -s "${OUTPUT}" ]]; then
    ...
    echo "${SAMPLE}: existing 250M output verified"
    continue
  fi
...
echo "All 250M downsampling jobs completed"
